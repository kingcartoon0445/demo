...
const CustomInput = ({ children, ...prop }) => {
    return (
        <div className="flex">
            <div className="pl-4 pr-2 bg-[var(--bg1)] rounded-l-xl whitespace-nowrap flex-nowrap flex items-center justify-center">
            ...
            <Input
                ...
                className="rounded-none rounded-r-xl border-none bg-[var(--bg1)] pl-0"
            />
        </div>
    );
};
...
export function CustomerUpdateCreate({ isUpdate, data, open, setOpen }) {
    ...
    const customStyles = {
        control: (base) => ({
            ...base,
            backgroundColor: "#fafafa", // bg-[var(--bg1)]
            border: "none",
                ...
                {socialPage ? (
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col w-full mt-4 gap-2">
                            ...
                            >
                                <SelectTrigger className="w-full rounded-xl border-none bg-[var(--bg1)]">
                        ...
                        <div className="flex flex-col w-full mt-4 gap-2">
                            ...
                            >
                                <DateInput
                                    className="w-full rounded-xl border-none bg-[var(--bg1)]"
                        ...
                        <div className="flex flex-col w-full mt-6 gap-2">
                            ...
                            <Input
                                ...
                                className="border-none bg-[var(--bg1)] rounded-xl"
                            />
                        </div>
                        <div className="flex flex-col w-full mt-6 gap-2">
                            <div className="text-title font-medium">
                    ...
                    <div className="flex flex-col items-center max-h-[70dvh] overflow-y-auto">
                        ...
                        >
                            {avatarPreview || defaultAvatar ? (
                                ...
                                <div className="w-[80px] aspect-square rounded-full bg-[var(--bg1)] flex items-center justify-center relative">
